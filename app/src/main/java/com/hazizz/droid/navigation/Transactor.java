package com.hazizz.droid.navigation;
...
import com.hazizz.droid.fragments.ThéraFrags.Setup.schedulesFragments.TheraSchedulesTabFragmentHoster;
...
public class Transactor extends FragmentActivity {
    ...
    public static void tabFragmentHosterThSchedules(@Nonnull FragmentTransaction fTransaction, int tabIndex){
        Bundle bundle = new Bundle();
        bundle.putInt(KEY_TABINDEX, tabIndex);
        TheraSchedulesTabFragmentHoster frag = new TheraSchedulesTabFragmentHoster();
        frag.setArguments(bundle);
        fTransaction.replace(R.id.fragment_container, frag);
        if(backStack){ fTransaction.addToBackStack(null); }
        fTransaction.commitAllowingStateLoss();
    ...
    public static void tabFragmentThSchedules(@Nonnull FragmentTransaction fTransaction, int tabIndex){
        tabFragmentHosterThSchedules(fTransaction, tabIndex);
    }
