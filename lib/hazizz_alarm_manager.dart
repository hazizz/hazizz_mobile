...
class HazizzAlarmManager extends AndroidAlarmManager{
  ...
  static Future<bool> hazizzPeriodic(
      Duration duration,
      int id,
    ...
    final int fromMilli = from.millisecondsSinceEpoch;
    //  final int now = DateTime.now().millisecondsSinceEpoch;
    final int period = duration.inMilliseconds;
    final int first = fromMilli;// + period;
    final CallbackHandle handle = PluginUtilities.getCallbackHandle(callback);
    if (handle == null) {
      print("log: return from handle");
      return false;
    }
  ...
  static Future<bool> oneShot(
    ...
    final int fromMilli = from.millisecondsSinceEpoch;
    // final int now = DateTime.now().millisecondsSinceEpoch;
    final int first = fromMilli + delay.inMilliseconds;
    final CallbackHandle handle = PluginUtilities.getCallbackHandle(callback);
    if (handle == null) {
      return false;
    }
