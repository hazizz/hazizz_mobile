...
/// ```
/// {@end-tool}
class HazizzTabController extends ChangeNotifier {
  ...
  HazizzTabController({ int initialIndex = 0, @required this.length, @required TickerProvider vsync })
  ...
  HazizzTabController _copyWith({ int index, int length, int previousIndex }) {
    return HazizzTabController._(
      index: index ?? _index,
