...
class ErrorCodes {
  ...
  static final List<ErrorCode> list = [
    UNKNOWN_ERROR, INVALID_DATA, DATABASE_ERROR,
    PATH_VARIABLE_MISSING, BAD_FORMATTING, INVALID_HTTP_METHOD,
    NOT_TRIMMED, REQUEST_PARAMETERS_MISSING, GENERAL_AUTHENTICATION_ERROR,
    FORBIDDEN, INVALID_PASSWORD, ACCOUNT_LOCKED, ACCOUNT_DISABLED,
    ACCOUNT_EXPIRED , UNKNOWN_PERMISSION, BAD_AUTHENTICATION_REQUEST, INVALID_TOKEN,
    RATE_LIMIT_REACHED, RECAPTCHA_ERROR, REFRESH_TOKEN_INVALID,
    ELEVATION_TOKEN_INVALID, AUTH_TOKEN_INVALID, AUTH_SERVER_UNAVAILABLE,
    GENERAL_USER_ERROR , USER_NOT_FOUND , USERNAME_CONFLICT, EMAIL_CONFLICT,
    REGISTRATION_DISABLED, CONSENT_MISSING , DISPLAYNAME_INVALID, GENERAL_GROUP_ERROR,
    GROUP_NOT_FOUND, GROUP_NAME_CONFLICT, CAN_NOT_JOIN_GROUP, CAN_NOT_INVITE,
    USER_ALREADY_IN_GROUP, BAD_PASSWORD, USER_NOT_IN_GROUP, PASSWORD_REQUIRED,
    GROUP_LIMIT, GENERAL_TASK_ERROR, TASK_NOT_FOUND, TASK_DATE_INVALID,
    TASK_LIMIT, GENERAL_COMMENT_ERROR, COMMENT_SECTION_NOT_FOUND, COMMENT_NOT_FOUND,
    USER_ALREADY_HAS_COMMENT, USER_DO_NOT_OWN_COMMENT, GENERAL_SUBJECT_ERROR,
    SUBJECT_NOT_FOUND, SUBJECT_LIMIT, GENERAL_PPICTURE_ERROR,
    PPICTURE_SIZE_ERROR, PPICTURE_FORMAT_ERROR, GENERAL_THERA_ERROR,
    THERA_AUTHENTICATION_ERROR, THERA_SESSION_NOT_FOUND,THERA_IN_SESSION_ERROR,
    THERA_URL_NON_EXISTANT, THERA_BAD_WEEKNUMBER,THERA_SESSION_NOT_ACTIVE,
    GENERAL_ANNOUNCEMENT_ERROR, ANNOUNCEMENT_NOT_FOUND, ANNOUNCEMENT_LIMIT
  ];
//endregion
}
