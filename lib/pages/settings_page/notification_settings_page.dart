                    ...
                    trailing: Switch(
                      ...
                      //  HazizzNotification.setReceiveNotification(value);
                        if(value){
                          ...
                          HazizzResponse response = await getResponse(AddFirebaseToken(userId: CacheManager.getMyIdSafely, firebaseToken: await HazizzMessageHandler().token));
                        //  HazizzNotification.scheduleNotificationAlarmManager();
                          ...
                          HazizzResponse response = await getResponse(RemoveFirebaseTokens(userId: CacheManager.getMyIdSafely, firebaseToken: await HazizzMessageHandler().token));
                        }
                      }
                    )
                  ),
