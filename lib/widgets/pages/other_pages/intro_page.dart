...
class _IntroPage extends State<IntroPage> with AutomaticKeepAliveClientMixin, SingleTickerProviderStateMixin{
  ...
  Future joinGroup() async {
    HazizzResponse hazizzResponse = await RequestSender().getResponse(RetrieveGroup.withoutMe(pGroupId: groupId));
    ...
    if(hazizzResponse.isSuccessful){
      ...
      if(groupWithoutMe != null){
        ...
        if(groupWithoutMe.userCount == groupWithoutMe.userCountWithoutMe){
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            showToast(localize(context, key: "already_in_group"), duration: 3.seconds);
                    ...
                    Padding(
                      ...
                      child: RaisedButton(child: Text(localize(context, key: "create_group").toUpperCase()), onPressed: () async {
                        ...
                        if(success != null && success){
                          showToast(localize(context, key: "group_created"), duration: 3.seconds);
